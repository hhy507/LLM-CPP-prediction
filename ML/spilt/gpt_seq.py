...
# 读取 Excel 文件
df = pd.read_excel('./gpt/CPP_encoded.xlsx')
...
val_data.to_excel('./ml/gpt_seq/gpt_seq_val.xlsx', index=False)
...
train_data.to_excel('./ml/gpt_seq/gpt_seq_train.xlsx', index=False)
