...
def load_and_predict(model_path="models/random_forest_model.pkl", test_path="data/test.xlsx", scaler_path="models/rf_scaler.pkl"):
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 50)
    print(" Random Forest Evaluation ".center(50, '='))
    print("=" * 50)
