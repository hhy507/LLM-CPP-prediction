...
class ClassificationEvaluator:
    ...
    def _plot_confusion_matrix(self):
        ...
        plt.yticks(fontsize=18, weight='bold')  # weight='bold' 表示加粗
        plt.xticks(fontsize=18, weight='bold')  # weight='bold' 表示加粗
    ...
    def _plot_roc_curve(self):
        ...
        plt.plot([0, 1], [0, 1], 'k--')
        plt.tick_params(axis='both', which='major', labelsize=18)  # 主刻度
        plt.xlim([0.0, 1.0])
        plt.ylim([0.0, 1.05])
    ...
    def _plot_pr_curve(self):
        ...
        plt.tick_params(axis='both', which='major', labelsize=18)  # 主刻度
        plt.xlabel('Recall',fontweight='bold', fontsize=24)
        plt.ylabel('Precision',fontweight='bold', fontsize=24)
