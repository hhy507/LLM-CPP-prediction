...
def load_and_predict(model_path="models/logistic_regression_model.pkl", test_path="data/test.xlsx", scaler_path="models/lr_scaler.pkl"):
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 50)
    print(" Logistic Regression Evaluation ".center(50, '='))
    print("=" * 50)
