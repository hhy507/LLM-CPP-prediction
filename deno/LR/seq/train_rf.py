...
def train_logistic_regression_freq():
    print("Preprocessing amino acid frequency features...")
    ...
    model = joblib.load("models/freq_logistic_regression.pkl")
    y_pred = model.predict(X_test)
    print(classification_report(y_test, y_pred, target_names=["Non-CPP", "CPP"]))

if __name__ == "__main__":
    train_logistic_regression_freq()