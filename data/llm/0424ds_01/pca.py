...
# ✅ 步骤1：读取数据
df = pd.read_excel("DS/CPP_encoded.xlsx", dtype={"CPP_Code": str})
...
plot_embedding(X_pca, labels, title="PCA (DS)", xlabel="Component 1", ylabel="Component 2", save_path="ds_pca.png")

# ✅ 步骤7：t-SNE 可视化
tsne = TSNE(n_components=2, random_state=42, perplexity=30)
X_tsne = tsne.fit_transform(X)
plot_embedding(X_tsne, labels, title="t-SNE (DS)", xlabel="Component 1", ylabel="Component 2", save_path="ds_tsne.png")

# ✅ 步骤8：UMAP 可视化
reducer = umap.UMAP(n_components=2, random_state=42)
X_umap = reducer.fit_transform(X)
plot_embedding(X_umap, labels, title="UMAP (DS)", xlabel="Component 1", ylabel="Component 2", save_path="ds_umap.png")

# ✅ 步骤9：保存带聚类标签的新Excel文件
df.to_excel("DS/CPP_clustered.xlsx", index=False)
